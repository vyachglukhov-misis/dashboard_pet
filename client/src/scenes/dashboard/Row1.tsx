...
import { useGetKpiesQuery } from "@/state/api"
...
const Row1 = () => {
  ...
  const {data} = useGetKpiesQuery("asd");
  ...
  return (
    ...
    <BoxHeader title="Revenue and Expenses" subtitle="top line represents revenue, bottom line represents expeneses" sideText="+4%"/>
      <ResponsiveContainer width="100%" height="100%">
          ...
          <defs>
            ...
            <YAxis tickLine={false} style={{fontSize: "10px"}} domain={[8000,23000]} axisLine={{strokeWidth: "0"}}/>
    ...
    <BoxHeader title="Profit and Revenue" subtitle="top line represents revenue, bottom line represents expeneses" sideText="+4%"/>
      <ResponsiveContainer width="100%" height="100%">
          <LineChart
          ...
          >
            ...
            <Legend height={25}  wrapperStyle={{margin: "0 0 10px 0", fontSize: "13px"}}/>
            <Tooltip wrapperStyle={{color: "black"}} itemStyle={{color: palette.primary[600]}}/>
